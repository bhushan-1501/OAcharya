					...
					<div class="booking-form">
						...
						<form method ="post">
							...
							<div class="form-group">
								...
								<select class="form-control" id="select-pooja" name="pooja" onchange="myFunction()">
												<option value="none" disabled selected>Select pooja</option>
												<option value="Ganapati Pooja">Ganapati Pooja</option>
												<option value="Laxmi Poojan">Laxmi Poojan</option>
												<option value="Wedding Ceremony">Wedding Ceremony</option>
												<option value="Namkaran">Namkaran</option>
												<option value="Satya Narayan">Satya Narayan</option>
												<option value="Mundan Ceremony">Mundan Ceremony</option>
												<option value="Antya Vidhi">Antya Vidhi</option>
							...
							<div class="form-group">
								...
								<input class="form-control"  placeholder="Amount"  id="amt"  name="amt" disabled>
							</div>
                            </div>
								</div> 
                            </div>
...
function myFunction() {
var x = document.getElementById("select-pooja").value;
if(x=="Ganapati Pooja")
{
	var amt="1501 /-";
}
